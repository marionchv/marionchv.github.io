...
- Marion Chauveau. Generative models for protein sequences. [PhD thesis manuscript](assets/pdf/PhD_manuscript_CHAUVEAU_Marion.pdf), 2025.
- Marion Chauveau. Generative models for protein sequences. [PhD thesis defense](assets/pdf/PhD_Defense_website.pdf), Paris, France, October 1<sup>st</sup> 2025.

## Talks

- Predicting compensatory mutations in proteins using statistical models - [BiGre Days](https://bi-gre.github.io/days/), February 2025. [[Slides](assets/pdf/Talk_BiGre_CHAUVEAU.pdf)]
- Graph dictionary learning for the study of human motion - [46th Annual International Conference of the IEEE EMBS](https://embc.embs.org/2024/), Summer 2024. [[Slides](assets/pdf/Talk_IEEE_CHAUVEAU.pdf)]
- Generative models of Protein sequences - Journées de la Physique Statistique, Winter 2024. [[Slides](assets/pdf/Talk_JPS_CHAUVEAU.pdf)]
- Generative models of Protein sequences - [5th course on Multi-scale Integration in Biological Systems](https://training.institut-curie.org/courses/multiscale-2023), Fall 2023. [[Slides](assets/pdf/Talk_InstitutCurie_CHAUVEAU.pdf)]
